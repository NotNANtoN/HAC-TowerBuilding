...
class Layer():
    ...
    def add_noise(self,action, env):
        ...
        if __debug__:
            ...
            print("action offset:",action_offset)
    ...
    def create_prelim_goal_replay_trans(self, hindsight_action, next_state, env, total_layers):
        ...
        """
        # Designer can create some additional goal replay transitions.  
        For instance, higher level transitions can be replayed with the subgoal achieved in hindsight as the original goal.
        if self.layer_number > 0:
